...
public class PaymentController {
    ...
    public PaymentResponse getById(@PathVariable UUID id) {
        log.info("Получен запрос на получение платежа с id={}", id);
    ...
    public List<PaymentResponse> getAll() {
        log.info("Получен запрос на получение всех платежей");
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Платеж успешно обновлён"),
            @ApiResponse(responseCode = "400", description = "Некорректные данные запроса"),
            @ApiResponse(responseCode = "404", description = "Платеж не найден")
    })
    public PaymentResponse update(
        ...
        log.info("Получен запрос на обновление платежа с id={}", id);
    ...
    public void delete(@PathVariable UUID id) {
        log.info("Получен запрос на удаление платежа с id={}", id);
